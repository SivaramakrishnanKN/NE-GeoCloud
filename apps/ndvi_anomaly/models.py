...
class Query(BaseQuery):
    ...
    color_scales = {
        'baseline_ndvi':
        '/home/' + settings.LOCAL_USER + '/Datacube/NE-GeoCloud/utils/color_scales/ndvi',
        'scene_ndvi':
        '/home/' + settings.LOCAL_USER + '/Datacube/NE-GeoCloud/utils/color_scales/ndvi',
        'ndvi_difference':
        '/home/' + settings.LOCAL_USER + '/Datacube/NE-GeoCloud/utils/color_scales/ndvi_difference',
        'ndvi_percentage_change':
        '/home/' + settings.LOCAL_USER + '/Datacube/NE-GeoCloud/utils/color_scales/ndvi_percentage_change'
    }
