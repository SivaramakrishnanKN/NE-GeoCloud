...
def tiling(request, z, x, y):
  ...
  #     img.save(response, "PNG")
      ...
      response = HttpResponse(content_type="image/png")
      img = Image.open("/home/localuser/Datacube/NE-GeoCloud/static/assets/results/cloud_free/cloud_free/" + z + "/" + x + "/" + y + ".png")
      img.save(response, "PNG")
      return response
        # return ("ok")
...
class OutputView(View):
    def post(self, request):
        ...
        if request.method == 'POST':
            ...
            cmd1 = 'rm -r /home/localuser/Datacube/NE-GeoCloud/static/assets/results/cloud_free/cloud_free'
            cmd2 = 'gdal2tiles.py -z 3-14 /home/localuser/Datacube/NE-GeoCloud/static/assets/results/cloud_free/cloud_free.png'
            cmds = [cmd,cmd1,cmd2]                                                                                                                                                                                                                                                  
            ...
            image = "/static/assets/results/cloud_coverage/cloud_free.png" 
            result = {"image" : image,
                        "lat_min" : lat_min,
                        "lat_max" : lat_max,
                        "long_min" : long_min,
